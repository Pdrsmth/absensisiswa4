...
INNER JOIN tb_semester ON tb_semester.id_semester=4
 	...
 	<tr>
 		...
 		<td>
 			<center>
 				...
 				<hr>
 				<em>
				 Jl. Lintas Sumbar-Riau Kec.Pangkalan Koto Baru,<br> Kab.Lima Puluh Kota Provinsi Sumatera Barat	 Kode Pos (26272) <br>
 		...
 		<td>
 			...
 			<table width="100%">
  <tr>
    <td colspan="2"><b style="border: 2px solid;padding: 4px; ">
...
<table width="100%" border="1" cellpadding="2" style="border-collapse: collapse;">
  ...
  <tr>
	...
	?> 
	<td></td>
	<td bgcolor="#FFFFFF" align="center">H</td>
