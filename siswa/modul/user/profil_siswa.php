        ...
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="blue">
                <a href="index.php" class="logo">
                    <b class="text-white">SMA Negeri 1 Pangkalan Koto Baru</b>
                </a>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <img src="../../../assets/img/user/<?= $data['foto'] ?>" class="img-fluid rounded" alt="Foto Siswa">
                                        </div>
                                        <div class="col-md-8">
                                ...
                                <div class="card-footer text-right">
                                    <!-- Tombol Kartu Tanda Pengenal -->
                                    <a href="kartu_identitas.php?id=<?= $data['id_siswa'] ?>" class="btn btn-info">Kartu Tanda Pengenal</a>
                                    <!-- Tombol Edit Profil -->
            ...
            <footer class="footer">
                <div class="container">
                    <div class="copyright ml-auto">
                        &copy; <?= date('Y'); ?> Absensi Siswa SMA Negeri 1 Pangkalan Koto Baru
                    </div>
                </div>
            </footer>
        </div>
