...
if ($kelasMengajar && mysqli_num_rows($kelasMengajar) > 0) {
    $data = mysqli_fetch_assoc($kelasMengajar);
    $namaKelas = $data['nama_kelas'] ?? 'Kelas Tidak Diketahui'; // Set nilai namaKelas
} else {
    $namaKelas = 'Kelas Tidak Diketahui'; // Nilai default jika tidak ada data
}
