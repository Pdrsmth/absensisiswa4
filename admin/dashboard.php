		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					<img src="../assets/img/SMA.PNG" alt="navbar brand" class="navbar-brand" width="30">
					<b class="text-white">CAMPUS LANSANO</b>
				</a>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi SMA Negeri 1 Pangkalan Koto Baru (<a href="index.php">Pedro Masdy </a> | 2024)
					</div>				
				</div>
			</footer>
		</div>
